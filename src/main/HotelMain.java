...
//		
//		Customer customer = new Customer("��������", 2, "02-987-6543");
//		GlobalData.roomList[0][2].setCustomer(customer);
//		customer = new Customer("��Ƽ���⽺", 1, "010-7777-7777");
//		GlobalData.roomList[1][2].setCustomer(customer);
//		customer = new Customer("��������", 3, "011-111-1234");
//		GlobalData.roomList[1][3].setCustomer(customer);
//		customer = new Customer("�ڼ���", 3, "8210-999-1111");
